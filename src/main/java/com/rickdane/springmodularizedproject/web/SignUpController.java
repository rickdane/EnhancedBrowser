...
public class SignUpController {
	...
	public String activateUser(
			...
			Model model) {
		TypedQuery<User> query = User.findUsersByActivationKeyAndEmailAddress(
				activationKey, emailAddress);
	...
	public String create(@Valid UserRegistrationForm userRegistration,
		...
		if (result.hasErrors()) {
			...
			User.setPassword(messageDigestPasswordEncoder.encodePassword(
			...
			mail.setText("Hi "
					+ User.getFirstName()
					+ ",\n. You had registered with us. Please click on this link to activate your account - <a href=\"http://__BASE_URL__/signup?emailAddress="
					+ User.getEmailAddress() + "&activate=" + activationKey
